...
class Character(object):
    ...
    def __init__(self,level):
        ...
        print()
        self.str = int(input("Please enter STRENGTH value: "))
        self.dex = int(input("Please enter DEXTERITY value: "))
        self.con = int(input("Please enter CONSTITUTION value: "))
        self.int = int(input("Please enter INTELLIGENCE value: "))
        self.wis = int(input("Please enter WISDOM value: "))
        self.cha = int(input("Please enter CHARISMA value: "))
        self.hp = 0
        self.classType = ''
        self.background = ''
    ...
    def chooseClass(self):
        ...
        if chosen_class == 'barbarian':
            barb_choice = input('Would you like to boost (1) Strength or (2) Constitution? ')
            print()
            ...
            clerc_choice = input('Would you like to boost (1) Wisdom, (2) Strength, or (3) Constitution? ')
            print()
            ...
            druid_choice = input('Would you like to boost (1) Wisdom or (2) Constitution? ')
            print()
            ...
            fight_choice = input('Would you like to boost (1) Strength, (2) Dexterity, or (3) Constitution? ')
            print()
            ...
            monk_choice = input("Would you like to boost (1) Wisdom or (2) Dexterity? ")
            print()
            ...
            pal_choice = input('Would you like to boost (1) Strength, (2) Constitution, or (3) Charisma? ')
            print()
            ...
            rang_choice = input('Would you like to boost (1) Strength, (2) Dexterity, or (3) Constitution? ')
            print()
            ...
            rog_choice = input('Would you like to boost (1) Strength, (2) Dexterity, or (3) Intelligence? ')
            print()
            ...
            wiz_choice = input('Would you like to boost (1) Intelligence or (2) Constitution? ')
            print()
    ...
    def backgroundAndSkills(self):
        ...
        background_choice = input('Enter a background from this list: '+str(background_list)+': ').title()
        print()
        ...
        if backgrounds[self.background]['hasProfession'] == True:
            ...
            temp_choice = input("Which profession would you like? "+str(profession_holder)+"\n"\
        ...
        for i in range(4):
            skill_choice.append(input("Which Skill would you like for skill "+str(i+1)+"? ").title())
        print()
    ...
    def chooseSpecialties(self):
        ...
        spec_choice = input("Which specialty would you like?\n"\
...
class Dwarf(Character):
    ...
    def __init__(self,level=1,characterName=randomNames["Dwarf"][r.randint(0,len(randomNames["Dwarf"])-1)]):
        ...
        self.subrace = input("Are you a (1) Hill Dwarf or (2) Mountain Dwarf? (input number) ")
        print()
...
class Elf(Character):
    ...
    def __init__(self,level=1,characterName=randomNames["Elf"][r.randint(0,len(randomNames["Elf"])-1)]):
        ...
        self.subrace = input("Are you a (1) High Elf or (2) Wood Elf? (input number) ")
        print()
        while self.subrace not in ['1','2']:
            self.subrace = input("Are you a (1) High Elf or (2) Wood Elf? (input number) ")
            print()
...
class Halfling(Character):
    ...
    def __init__(self,level=1,characterName=randomNames["Halfling"][r.randint(0,len(randomNames["Halfling"])-1)]):
        ...
        self.subrace = input("Are you (1) Lightfoot or (2) Stout? (input number) ")
        print()
        while self.subrace not in ['1','2']:
            self.subrace = input("Are you a (1) Lightfoot or (2) Stout? (input number) ")
            print()
